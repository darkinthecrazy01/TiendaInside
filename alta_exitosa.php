...
<div class="container">
  ...
  <div class="subcontenedor">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1><!-- InstanceBeginEditable name="olantilla" -->Tu registro a sido realizado exitosamenete<!-- InstanceEndEditable --></h1>
    <!-- InstanceBeginEditable name="Contenido" -->
    <p>Muchas Gracias por registrarte!!</p>
    <p>Ahora ya podras realizar tus compras desde la comodidad de tu computadora.</p>
    <!-- InstanceEndEditable -->
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
