...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tblsubcategoria SET strDescripcion=%s WHERE idSubcategoria=%s",
  ...
  $updateGoTo = "subcategoria_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$varSubcategoria_Recordset1 = "0";
if (isset($_GET["recordID"])) {
  $varSubcategoria_Recordset1 = $_GET["recordID"];
}
mysql_select_db($database_conexionInsite, $conexionInsite);
$query_Recordset1 = sprintf("SELECT * FROM tblsubcategoria WHERE tblsubcategoria.idSubcategoria = %s", GetSQLValueString($varSubcategoria_Recordset1, "int"));
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="submit" value="Actualizar Subcategoria" /></td>
        </tr>
      </table>
      <input type="hidden" name="MM_update" value="form1" />
      <input type="hidden" name="idSubcategoria" value="<?php echo $row_Recordset1['idSubcategoria']; ?>" />
    </form>
    <p>&nbsp;</p>
