...
$query_Recordset1 = "SELECT * FROM tblsubcategoria ORDER BY tblsubcategoria.strDescripcion ASC";
...
<nav>Administracion de Tienda INSITE</nav
  ...
  <div id="content">
	...
	<h1>Subcategoria Lista</h1>
	<p><a href="subcategoria_add.php">A&ntilde;adir Subcategoria</a></p>
	<table width="100%" border="0">
	  ...
	  <?php do { ?>
	    <tr class="brillo">
	      ...
	      <td><a href="subcategoria_edit.php?recordID=<?php echo $row_Recordset1['idSubcategoria']; ?>">Editar</a> - <a href="subcategorias_delete.php?recordID=<?php echo $row_Recordset1['idSubcategoria']; ?>">Eliminar</a></td>
	      </tr>
