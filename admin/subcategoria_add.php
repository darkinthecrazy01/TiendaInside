...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblsubcategoria (strDescripcion) VALUES (%s)",
  ...
  $insertGoTo = "subcategoria_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<nav>Administracion de Tienda INSITE</nav
  ...
  <div id="content">
	...
	{
		 self.name = 'opener';  
		 remote = open('gestionimagen2.php','remote','width=400,height=150,location=no,scrollbars=yes,menubar=no,toolbars=no,resizable=yes,fullscreen=no,status=yes');  remote.focus();
	}
